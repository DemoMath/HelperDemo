...
public class StatusExpandAdapter extends BaseExpandableListAdapter {
	...
	private List<QiandaoGroupBean> groupList;
	...
	public StatusExpandAdapter(Context context,
			List<QiandaoGroupBean> group_list) {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.layout_qiandao_group_item, null);
		}
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		QiandaoChildBean entity = (QiandaoChildBean) getChild(groupPosition,childPosition);
		if (convertView != null) {
			viewHolder = (ChildViewHolder) convertView.getTag();
		} else {
			viewHolder = new ChildViewHolder();
			convertView = inflater.inflate(R.layout.layout_qiandao_child_item, null);
			viewHolder.twoStatusTime = (TextView) convertView
					.findViewById(R.id.two_complete_time);
		}
		viewHolder.twoStatusTime.setText(entity.getQiandaoTime() + " " + entity.getQiandaoAddress());
